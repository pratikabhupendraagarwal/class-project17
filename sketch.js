var monkey,ground,banana,stone,invg,stoneGroup,bananaGroup,score=0,health=2,play=0,end=1,gameState=0,h1,h2,h3,gameOver,restart,uphill;
...
function setup() {
  ...
  h3 = createSprite(59,20);
  h3.addAnimation("heart3",hp);
  h3.scale=0.06;
